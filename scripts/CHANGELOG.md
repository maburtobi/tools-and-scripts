...
### Changed
- **`port_check.sh`**: Removed UDP scanning capability to streamline the script for TCP-only checks.

## [1.3.0] - 2025-12-25

### Changed
- **`ipinfo.sh`**: Enhance IP information output with country details and a country summary.
